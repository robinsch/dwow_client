...
function PaperDollFrame_SetLevel()
	...
	if ( UnitClassSecondary("player") == 1 ) then
		secondaryClassName = " / Warrior";
	elseif ( UnitClassSecondary("player") == 2 ) then
		secondaryClassName = " / Paladin";
	elseif ( UnitClassSecondary("player") == 3 ) then
		secondaryClassName = " / Hunter";
	elseif ( UnitClassSecondary("player") == 4 ) then
		secondaryClassName = " / Rogue";
	elseif ( UnitClassSecondary("player") == 5 ) then
		secondaryClassName = " / Priest";
	elseif ( UnitClassSecondary("player") == 6 ) then
		secondaryClassName = " / Death Knight";
	elseif ( UnitClassSecondary("player") == 7 ) then
		secondaryClassName = " / Shaman";
	elseif ( UnitClassSecondary("player") == 8 ) then
		secondaryClassName = " / Mage";
	elseif ( UnitClassSecondary("player") == 9 ) then
		secondaryClassName = " / Warlock";
	elseif ( UnitClassSecondary("player") == 11 ) then
		secondaryClassName = " / Druid";
	end

	CharacterLevelText:SetFormattedText(PLAYER_LEVEL, UnitLevel("player"), UnitRace("player"), UnitClass("player")..secondaryClassName);
