	...
	for i=1, MAX_RAID_MEMBERS do
		...
		if ( i <= numRaidMembers ) then
			...
			if ( raidGroup.nextIndex <= MEMBERS_PER_RAID_GROUP ) then
				...
				local secondaryFileName = "";
				if ( UnitClassSecondary(name) == 1 ) then
					secondaryClassName = " / Warrior";
					secondaryFileName = "WARRIOR";
				elseif ( UnitClassSecondary(name) == 2 ) then
					secondaryClassName = " / Paladin";
					secondaryFileName = "PALADIN";
				elseif ( UnitClassSecondary(name) == 3 ) then
					secondaryClassName = " / Hunter";
					secondaryFileName = "HUNTER";
				elseif ( UnitClassSecondary(name) == 4 ) then
					secondaryClassName = " / Rogue";
					secondaryFileName = "ROGUE";
				elseif ( UnitClassSecondary(name) == 5 ) then
					secondaryClassName = " / Priest";
					secondaryFileName = "PRIEST";
				elseif ( UnitClassSecondary(name) == 6 ) then
					secondaryClassName = " / Death Knight";
					secondaryFileName = "DEATHKNIGHT";
				elseif ( UnitClassSecondary(name) == 7 ) then
					secondaryClassName = " / Shaman";
					secondaryFileName = "SHAMAN";
				elseif ( UnitClassSecondary(name) == 8 ) then
					secondaryClassName = " / Mage";
					secondaryFileName = "MAGE";
				elseif ( UnitClassSecondary(name) == 9 ) then
					secondaryClassName = " / Warlock";
					secondaryFileName = "WARLOCK";
				elseif ( UnitClassSecondary(name) == 11 ) then
					secondaryClassName = " / Druid";
					secondaryFileName = "DRUID";
				end

				class = class..secondaryClassName;
				...
				-- Fill in secondary class list
				if ( secondaryFileName ~= "" ) then
					tinsert(RAID_SUBGROUP_LISTS[secondaryFileName], i);
					--if ( UnitExists("raidpet"..i) ) then
					if ( secondaryFileName == "HUNTER" or secondaryFileName == "WARLOCK" ) then
						tinsert(RAID_SUBGROUP_LISTS["PETS"], i);
					end		
					--end
				end
